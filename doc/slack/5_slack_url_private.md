# Get the Integration URL for Private Cloud (Fyre, TEE, ...) - Concert Operate Tunnel

As the Slack integration requires a two-way communication and for Slack to communicate with the Concert Operate server, you need to configure a tunnel, a feature that is included in IBMAIOPS.
...
1. Open your Concert Operate Web UI
...
1. Enter the connection information for the Bastion/Tunnel Cluster:
   ...
   - Enter your registry password/pull-token from [https://myibm.ibm.com/products-services/containerlibrary](https://myibm.ibm.com/products-services/containerlibrary). This allows the Concert Operate tunnel images to be pulled from the IBM Container Registry.

   ![secure_gw_search](images/tunnel4.png)

1. Click `Finish`

1. Concert Operate will install the tunnel. This will take some time (up to 5 minutes)
