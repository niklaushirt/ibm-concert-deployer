...
echo "***************************************************************************************************************************************************"
echo ""
echo " 🚀  Concert Operate Create and run Training Definitions"
echo ""
echo "***************************************************************************************************************************************************"
echo "***************************************************************************************************************************************************"
echo "***************************************************************************************************************************************************"
...
# https://ai-platform-api-ibm-aiops.itzroks-270003bu3k-qd899z-6ccd7f378ae819553d37d5f2ee142bd6-0000.eu-de.containers.appdomain.cloud/graphql
...
export result=$(curl "https://$ROUTE/graphql" -k -s -H 'Accept-Encoding: gzip, deflate, br' -H 'Content-Type: application/json' -H 'Accept: application/json' -H 'Connection: keep-alive' -H 'DNT: 1' -H 'Origin: https://ai-platform-api-ibm-aiops.itzroks-270003bu3k-qd899z-6ccd7f378ae819553d37d5f2ee142bd6-0000.eu-de.containers.appdomain.cloud' --data-binary '{"query":"  mutation toggleAlgorithmEnablement {\n    toggleAlgorithmEnablement(algorithmName: Moving_Average_Log_Anomaly_Detection) {\n      message\n      status\n    }\n  }\n"}' --compressed)

# CREATE DATASET LAD
export result=$(curl 'https://ai-platform-api-ibm-aiops.itzroks-270003bu3k-pp4gqc-6ccd7f378ae819553d37d5f2ee142bd6-0000.eu-gb.containers.appdomain.cloud/graphql' -H 'Accept-Encoding: gzip, deflate, br' -H 'Content-Type: application/json' -H 'Accept: application/json' -H 'Connection: keep-alive' -H 'DNT: 1' -H 'Origin: https://ai-platform-api-ibm-aiops.itzroks-270003bu3k-pp4gqc-6ccd7f378ae819553d37d5f2ee142bd6-0000.eu-gb.containers.appdomain.cloud' --data-binary '{"query":"mutation createDataSet {\n  createDataSet(\n    startTimestamp: \"2021-05-05T00:00:00.000Z\"\n    endTimestamp: \"2021-05-07T00:00:00.000Z\"\n    notes: \"Automatically created by Nicks scripts\"\n    connections:\"\"\n  ) {\n    dataSetId\n  }\n}"}' --compressed
