...
echo " "
echo "   ------------------------------------------------------------------------------------------------------------------------------"
echo "   🚀  Deactivating Catalog Service for Demo Scenario..."
echo "   ------------------------------------------------------------------------------------------------------------------------------"
oc patch service catalogue -n sock-shop --patch '{"spec": {"selector": {"name": "catalog-outage"}}}'
...
./tools/01_demo/scripts/simulate-metrics-sock-network.sh
