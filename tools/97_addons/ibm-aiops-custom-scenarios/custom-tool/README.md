<center> <h1>🐣 CloudPak for Concert Operate - Demo-in-a-Box</h1> </center>
...
The idea of this repo is to provide an easy way to ingest demo data into an existing CP4Concert Operate cluster.

## 🚀 Getting Started

🐥 [Quick Install](#1-preparation)

- Get an OpenShift Cluster with Concert Operate installed
- Clone this repo
- Install prereqs
...
The remainder of this readme assumes you have an existing OCP + Concert Operate cluster.
