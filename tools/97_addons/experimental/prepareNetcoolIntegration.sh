...
echo "    🌏 Hostname:       $EVTMGR_INSTANCE-objserv-agg-primary.ibm-aiops-evtmgr.svc.cluster.local"
echo "    🚪 Port:           4100"
echo ""
echo "  📥 Backup ObjectServer (optional)"
echo "    🌏 Hostname:       $EVTMGR_INSTANCE-objserv-agg-backup.ibm-aiops-evtmgr.svc.cluster.local"
echo "    🚪 Port:           4100"
echo ""
echo ""
...
echo ""
echo "  alter table alerts.status ADD COLUMN Concert OperateAlertId VARCHAR(64);"
echo "  go"
echo "  alter table alerts.status ADD COLUMN Concert OperateState VARCHAR(16);"
echo "  go"
